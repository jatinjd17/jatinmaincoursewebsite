...
// import { useCoursesContext } from "../../context/context";
...
const SingleCoursePage = () => {
  ...
  useEffect(() => {
    ...
    let singleCourse = courses.find((course) => course.id === id);
    setsinglecoursedata(singleCourse);
  }, []);
        ...
        <SingleCourseWrapper>
          <div className="course-intro mx-auto grid">
            <div className="course-img">
              ...
              <Image src={singlecoursedata.image} width={400} height={400} />
            </div>
            <div className="course-details">
              ...
              <div className="course-head">
                <h5>{singlecoursedata.course_name}</h5>
              </div>
              <div className="course-body">
                ...
                <div className="course-rating flex">
                  <span className="rating-star-val fw-8 fs-16">
                    {singlecoursedata.rating_star}
                  </span>
                  <StarRating rating_star={singlecoursedata.rating_star} />
                  <span className="rating-count fw-5 fs-14">
                    ({singlecoursedata.rating_count})
                  </span>
                  <span className="students-count fs-14">
                    {singlecoursedata.students}
                  </span>
                </div>
                ...
                <ul className="course-info">
                  ...
                  <li className="flex">
                    ...
                    <span className="fs-14 course-info-txt fw-5">
                      Last updated {singlecoursedata.updated_date}
                    </span>
                  </li>
                  <li className="flex">
                    <span>
              ...
              <div className="course-foot">
                <div className="course-price">
                  <span className="new-price fs-26 fw-8">
                    ${singlecoursedata.discounted_price}
                  </span>
                  <span className="old-price fs-26 fw-6">
                    ${singlecoursedata.actual_price}
                  </span>
                </div>
              </div>
              ...
              <div className="course-btn">
                {cartlistinfo.filter(
                  (e) => e?.coursename === singlecoursedata.course_name
                ).length > 0 ? (
                  ...
                  <Link
                    ...
                    onClick={() => {
                      setCartlistinfo([
                        ...cartlistinfo,
                        {
                          coursename: singlecoursedata.course_name,
                          price: singlecoursedata.discounted_price,
                        },
                      ]);
          ...
          <div className="course-full bg-white text-dark">
            <div className="course-learn mx-auto">
              ...
              <ul className="course-learn-list grid">
                {singlecoursedata.what_you_will_learn &&
                  singlecoursedata.what_you_will_learn.map((learnItem, idx) => {
                    return (
                      <li key={idx}>
                        <span>
                          <BiCheck />
            ...
            <div className="course-content mx-auto">
              ...
              <ul className="course-content-list">
                {singlecoursedata.content &&
                  singlecoursedata.content.map((contentItem, idx) => {
                    return (
                      <li key={idx}>
